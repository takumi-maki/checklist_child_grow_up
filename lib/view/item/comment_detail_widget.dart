...
class _CommentDetailWidgetState extends State<CommentDetailWidget> {
  ...
  void initState() {
    ...
    if (!widget.isMine &&
        !widget.comment.readAccountIds.contains(currentFirebaseUser.uid)) {
      Future(() async {
  ...
  Future<void> updateReadAccountIds() async {
    ...
    var updateCommentResult = await CommentFirestore.updateComment(
        widget.roomId, widget.checkListId, updatedComment);
    if (!updateCommentResult) {
      if (!mounted) return;
      final updateErrorSnackBar =
          ErrorSnackBar(context, title: '既読機能の更新に失敗しました');
        ...
        children: [
                  ...
                  : Padding(
                      ...
                      child: Text(
                          DateFormat('yyyy.MM.dd')
                              .format(widget.comment.createdTime.toDate()),
              ...
              : Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color:
                            widget.isMine ? Colors.grey.shade300 : Colors.white,
          ...
          StreamBuilder<QuerySnapshot>(
              stream: AccountFirestore.accounts
                  .where('id', isEqualTo: widget.comment.postedAccountId)
                  .snapshots(),
              builder: (context, accountSnapshot) {
                ...
                Map<String, dynamic> data = accountSnapshot.data!.docs.first
                ...
                return CommentAccountDetailWidget(
                    account: account, isMine: widget.isMine);
              }),
        ],
      ),
    );
