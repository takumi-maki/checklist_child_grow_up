          ...
          return Card(
            child: Padding(
              ...
              child: ListTile(
                ...
                iconColor: aboutAppContentList[index].id == 'deleteAccount' ? Theme.of(context).errorColor : Colors.black87,
                textColor: aboutAppContentList[index].id == 'deleteAccount' ? Theme.of(context).errorColor : Colors.black87,
