            ...
            return Card(
              child: Padding(
                ...
                child: ListTile(
                  ...
                  iconColor: aboutRoomContentList[index].id == 'deleteRoom' ? Theme.of(context).errorColor : Colors.black87,
                  textColor: aboutRoomContentList[index].id == 'deleteRoom' ? Theme.of(context).errorColor : Colors.black87,
