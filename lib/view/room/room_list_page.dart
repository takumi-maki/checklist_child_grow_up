      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
            stream: RoomFirestore.rooms
                .where('registered_email_addresses',
                    arrayContains: currentFirebaseUser.email)
            ...
            builder: (context, roomSnapshot) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    Map<String, dynamic> data = roomSnapshot.data!.docs[index]
                        .data() as Map<String, dynamic>;
                    final Room room = Room(
                        id: data['id'],
                        childName: data['child_name'],
                        birthdate: data['birthdate'],
                        registeredEmailAddresses:
                            data['registered_email_addresses'],
